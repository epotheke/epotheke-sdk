...
- An instance of `TerminalFactory` for NFC functionality which can be obtained by calling `instance()` function of the `AndroidTerminalFactory` class for android and `IosTerminalFactory.companion.instance` for iOS.
