...
|requestCardInsertion(): SmartCardDeviceConnection
|A connection to the eGK has to be provided.
|A connection can be established by the use of TerminalFactory instances.
There is a default implementation `SmartCardConnector` which can be used in mobile cases.
